...
const argv = yargs
  ...
  .option('resultsDirPath', {
    type: 'string',
    description: 'cypress multi reporter results directory ( relative path )'
  })
  .option('weightsJson', {
    alias: 'w',
    type: 'string',
...
const settings = {
  ...
  resultsDirPath: argv.resultsDirPath ? argv.resultsDirPath : 'runner-results',
};
